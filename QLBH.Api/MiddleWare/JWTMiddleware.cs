...
namespace QLBH.Api.MiddleWare
{
    public class JWTMiddleware : IMiddleware
    {
        ...
        {
            string Token = context.Request.Headers[Common_Constants.AppSettingJWT.Authorization].FirstOrDefault()?.Split(" ").Last();
        ...
        public void AttachUserToContext(HttpContext context, string Token)
        {
            ...
            var permissions = jwtToken.Claims.FirstOrDefault(c => c.Type == "role");
